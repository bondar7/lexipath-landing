    ...
    <div className="flex flex-col h-full bg-gray-50">
      ...
      <div className="bg-white px-3 md:px-4 py-3 md:py-4 shadow-sm">
        <div className="flex items-center justify-between">
          ...
          <h2 className="text-sm md:text-base font-bold text-gray-900">Add Custom List</h2>
      ...
      <div className="flex-1 overflow-y-auto p-3 md:p-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] pb-6">
        ...
        <div className="bg-white p-4 md:p-6 rounded-xl md:rounded-2xl shadow-sm mb-4 md:mb-6">
          <h3 className="text-sm md:text-base font-bold text-gray-900 mb-4">📝 Create Manually</h3>
          <div className="space-y-3 md:space-y-4">
            ...
            <button className="w-full bg-blue-500 text-white py-3 rounded-xl font-medium text-xs md:text-sm hover:bg-blue-600 active:bg-blue-700 transform hover:scale-105 active:scale-95 transition-all duration-200 shadow-sm hover:shadow-md">
              Create List
            </button>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-3 md:p-4 rounded-lg border border-purple-200 mb-3 md:mb-4">
          <div className="flex items-center space-x-2 mb-2 md:mb-3">
            <Sparkles className="w-4 md:w-5 h-4 md:h-5 text-purple-600" />
            <h3 className="text-sm md:text-base font-bold text-gray-900">🤖 Generate with AI</h3>
          </div>
          ...
          <div className="space-y-2 md:space-y-3">
            ...
            <button className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 rounded-xl font-medium text-xs md:text-sm hover:from-purple-600 hover:to-pink-600 transform hover:scale-105 active:scale-95 transition-all duration-200 shadow-sm hover:shadow-md">
              ✨ Generate AI Words
            </button>
          </div>
        </div>
